        ...
        <div class="modal-body">
          <div class="d-flex justify-content-between mb-3">
            ...
            <div class="d-flex align-items-start">
              ...
              <button type="button" class="btn btn-danger ml-3" data-toggle="modal" data-target="#model-add">
                <span id="add" class="mx-2" style="font-size: 15px">Delete All</span>
              </button>
            </div>
          </div>
          <Table :items="setPages" :fields="['Name', 'Birthday', 'Address']" :labels="['name', 'birthday', 'address']"
          ...
          <Pagination :numberOfPages="data.numberOfPages" :totalRow="data.totalRow" :startRow="data.startRow"
            :endRow="data.endRow" v-model:currentPage="data.currentPage" />
        </div>
      </div>
    </div>
  </div>
