<template>
  <div>
    <table class="my-table table-container">
      ...
      <tbody>
        <tr>
          ...
          <td class="size-16">{{ info.phone }}</td>
          <td class="size-16">{{ info.email }}</td>
          <td class="size-16">{{ info.Position?.name }}</td>
    ...
    <p v-if="!info" class="text-center mt-2">
