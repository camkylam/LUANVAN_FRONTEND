<template>
    <div>
      <table class="my-table table-container">
        ...
        <tbody>
          <tr v-for="(item, index) in acceptRecommendation" :key="index">
            ...
            <td class="size-16">{{ item.PartyMember?.Hamlet?.Ward?.name}}</td>
            <td class="size-16">{{ item.PartyMember?.Hamlet?.Ward?.District?.name}}</td>
            <td class="size-16">{{ item.PartyMember?.Hamlet?.Ward?.District?.Cty_Province?.name}}</td>
            <td class="">
