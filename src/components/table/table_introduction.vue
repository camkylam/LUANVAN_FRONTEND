  ...
  <div>
    <table class="my-table table-container">
      ...
      <tbody>
        <tr v-if="itemType=='info'">
          ...
          <td class="">
            <div class="d-flex align-items-center" v-if="activeAction == true">
              ...
              <button type="button" class="format-btn" data-toggle="modal" :class="{ 'your-green-button-class': !opinion?.error,
                   'your-default-button-class': opinion?.error }">
              ...
              <button type="button" class="format-btn" data-toggle="modal" 
              :class="{ 'your-green-button-class': hasLatestCommentInfo(comment.document) === 'your-blue-button-class',
        ...
        <tr v-if="itemType!='info'" v-for="(item, index) in sortedItems" :key="index"  >
          <td>
          ...
          <!-- <td class="size-16">{{ (item?.exemption === true || item.PartyMember?.exemption === true) ? 'Được miễn' : 'Không được miễn' }}</td> -->
          ...
          <td class="">
            <div class="d-flex align-items-center" v-if="activeAction == true">
              ...
              <button  type="button" class="format-btn" data-toggle="modal">
                ...
                :class="{ 'your-info-button-class': !item.opinion?.error,
                   'your-default-button-class': item.opinion?.error }"
