...
<template>
  <div class="border-box d-flex flex-column ml-2">
    ...
    <div class="d-flex menu my-3 mx-3 justify-content-end">
      <a @click="activeMenu = 1" :class="[activeMenu == 1 ? 'active-menu' : 'none-active-menu']" href="#">Đảng viên</a>
      <a @click="activeMenu = 2" :class="[activeMenu == 2 ? 'active-menu' : 'none-active-menu']" href="#">Chức vụ</a>
    </div>
    <!-- Filter -->
    <!-- Search -->
    ...
    <!-- Table -->
    <Table :items="setPages" :fields="['Chức vụ', 'Số lượng']" :labels="['position', 'amount']"
      @delete="(value) => deleteOne(value)" @edit="(value, value1) => (
