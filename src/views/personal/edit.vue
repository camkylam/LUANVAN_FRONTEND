            ...
            <div class="d-flex flex-grow-1 flex-column step-content px-3 my-3  " style="width: 10000px">
              ...
              <form v-if="data.activeStep == 1" action="" class="was-validated " style="width: 100%">
                <div class="form-group flex-grow-1">
                  ...
                  <input type="text" class="form-control capitalize" id="name" name="name" v-model="item.name" required />
                </div>
                <div class="form-group flex-grow-1">
                ...
                <div class="form-group flex-grow-1">
                  ...
                  <input type="text" class="form-control capitalize" id="address" name="address" v-model="item.address" required />
                </div>
                <div class="form-group flex-grow-1">
                ...
                <div class="form-group flex-grow-1">
                  ...
                  <input type="text" class="form-control capitalize" id="email" name="email" v-model="item.email" required />
                </div>
                <div class="form-group flex-grow-1">
