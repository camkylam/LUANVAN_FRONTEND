  ...
  <div class="modal" id="model-view">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="">
            <button
              ...
              @click="handleActivePartyMember()"
            >
              Thông tin cá nhân
            </button>
            <div
              v-if="isActivePartyMember"
              id="personal-info"
          ...
          <div class="mt-2">
            ...
            >
              <div
                class="d-flex justify-content-around align-items-center capitalize "
                style="height: 100px"
              >
                <div>
                  <p>
                    <span class="font-weight-bold">Chi bộ: </span>
                    {{ item.PartyCell?.name }}
                  </p>
                  <p>
        ...
        <!-- <div class="modal-body" v-if="itemType == 'recommenwards'">
          <div class="">
            <button
              data-toggle="collapse"
              class="px-3 py-2 h6 border-none"
            ...
            >
              <div class="d-flex justify-content-around row mx-3">
                <div class="mt-3 col-6">
                  ...
                  <p>
                    <span class="font-weight-bold">Giới tính: </span>
                    {{ item.PartyMember.gender }}
                  </p>
                  <p>
                    <span class="font-weight-bold">Chức vụ: </span>
                    {{ item.PartyMember.Position.name }}
                  </p>
                </div>
                <div class="mt-3 col-6">
                  <p>
                    <span class="font-weight-bold">Địa chỉ: </span>
                    {{ item.PartyMember.address }}
                  </p>
                  <p>
                    <span class="font-weight-bold">Email: </span>
                    {{ item.PartyMember.email }}
                  </p>
                  
                  <p>
                    <span class="font-weight-bold">Ngày kết nạp Đảng: </span>
                    {{ item.PartyMember.dateJoin }}
                  </p>
                  <p>
                    <span class="font-weight-bold">Ngày vào Đảng chính thức: </span>
                    {{ item.PartyMember.dateOfficial }}
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                <div>
                  <p>
                    <span class="font-weight-bold">Chi bộ: </span>
                    {{ item.PartyMember.PartyCell.name }}
                  </p>
                  <p>
                    <span class="font-weight-bold">Tỉnh, thành phố: </span>
                    {{ item.PartyMember.Hamlet.Ward.District.Cty_Province.name }}
                  </p>
                </div>
                <div>
                  <p>
                    <span class="font-weight-bold">Quận, huyện: </span>
                    {{ item.PartyMember.Hamlet.Ward.District.name }}
                  </p>
                  <p>
                    <span class="font-weight-bold">Xã, phường: </span>
                    {{ item.PartyMember.Hamlet.Ward.name }}
                  </p>
                  <p>
                    <span class="font-weight-bold">Khu vực, ấp: </span>
                    {{ item.PartyMember.Hamlet.name }}
                  </p>
                </div>
              </div>
            </div>
